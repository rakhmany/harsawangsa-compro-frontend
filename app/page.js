          ...
          <div className="row justify-content-center">
            <div className="col-12 col-xl-12">
              ...
              >
                ...
                <div 
                  className="position-absolute top-50 start-50 translate-middle hero-text text-center"
                  style={{ maxWidth: "750px", zIndex: 10 }}
                >
                  <h1 
                  ...
                  <a href="/explore" className="d-inline-block">
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-5px)";
                  e.currentTarget.style.boxShadow = "0 15px 40px #f4891d4f";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0)";
