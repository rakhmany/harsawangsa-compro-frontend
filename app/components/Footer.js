      ...
      <div className={styles.container}>
        <div className={styles.mainContent}>
          ...
          <div className={styles.linksSection}>
            <h6 className={styles.linkTitle}>LINKS</h6>
            <ul className={styles.linkList}>
              ...
              <li><Link href="/marketing" className={styles.link}>Marketing</Link></li>
              <li><Link href="/branding" className={styles.link}>Branding</Link></li>
            </ul>
          </div>

          {/* Services Section */}
          <div className={styles.linksSection}>
            <h6 className={styles.linkTitle}>SERVICES</h6>
            <ul className={styles.linkList}>
              <li><Link href="/services/seo" className={styles.link}>SEO Services</Link></li>
              <li><Link href="/services/ppc" className={styles.link}>PPC & Search Marketing</Link></li>
              <li><Link href="/services/design" className={styles.link}>Website Design</Link></li>
              <li><Link href="/services/development" className={styles.link}>Development</Link></li>
            </ul>
          </div>
          ...
          <div className={styles.linksSection}>
            ...
            <ul className={styles.linkList}>
              <li><Link href="/legal" className={styles.link}>Legal</Link></li>
          ...
          {/* Head Office */}
          <div className={styles.linksSectionOffice}>
            <h6 className={styles.linkTitle}>HEAD OFFICE</h6>
            <ul className={styles.linkList}>
            ...
            <div className={styles.newsletterForm}>
              ...
              onClick={() => {
                ...
                window.location.href = `mailto:newsletter@harsawangsa.com?subject=Newsletter Subscription&body=Please subscribe ${email} to the newsletter`;
                } else {
        ...
        <div className={styles.bottomSection}>
          <p className={styles.copyright}>
            Copyright © 2025 Harsawangsa. All right reserved
          </p>
          <div className={styles.bottomLinks}>
            <Link href="/terms" className={styles.bottomLink}>Terms Of Use</Link>
            <Link href="/privacy" className={styles.bottomLink}>Privacy Policy</Link>
            <Link href="/security" className={styles.bottomLink}>Security</Link>
          </div>
        </div>
      </div>
    </footer>
